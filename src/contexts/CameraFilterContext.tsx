...
interface CameraFilterContextValue {
  // Color filter
  filterId: string;
...
const CameraFilterContext = createContext<CameraFilterContextValue>({} as CameraFilterContextValue);

export const useCameraFilterContext = () => useContext(CameraFilterContext);

export const CameraFilterProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
